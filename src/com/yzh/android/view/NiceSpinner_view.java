...
import com.yzh.spinnerview.NiceSpinnerAdapter;
import com.yzh.spinnerview.NiceSpinnerAdapterWrapper;
import com.yzh.spinnerview.NiceSpinnerBaseAdapter;
...
public class NiceSpinner_view extends TextView {
    ...
    public NiceSpinner_view(Context context) {
        super(context);
        init(context, null);
    }

    public NiceSpinner_view(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NiceSpinner_view(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NiceSpinner_view);
...
//            defaultPadding);
        ...
        mHideArrow = typedArray.getBoolean(R.styleable.NiceSpinner_view_hideArrow, false);
        if (!mHideArrow) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.arrow);
            int resId = typedArray.getColor(R.styleable.NiceSpinner_view_arrowTint, -1);
