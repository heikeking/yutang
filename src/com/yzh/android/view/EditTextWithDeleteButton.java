...
public class EditTextWithDeleteButton extends LinearLayout {	
	...
	private void initViews(Context context, AttributeSet attrs) {
		...
		try {
			...
			edittextColor =a.getInteger(R.styleable.EditTextWithDeleteButton_edittextcolor, R.color.edit_text);
		} finally {
			a.recycle();
		}
		editText = createEditText(context, hintText,edittextColor);
	...
	@SuppressLint("NewApi")
	private EditText createEditText(Context context, String hintText,int textcolor) {
