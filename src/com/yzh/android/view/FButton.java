...
public class FButton extends Button implements View.OnTouchListener {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            }else if(attr==R.styleable.FButton_width_btn){
            	width = typedArray.getFloat(attr, -2);
            }else if(attr==R.styleable.FButton_height_btn){
            	height = typedArray.getFloat(attr, -2);
            }
        }
        typedArray.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //Log.i("Cache", "width:"+width +"    height:"+height);
        //设置宽高
    ...
    private int measureWidth(int measureSpec) {
    	DisplayMetrics dm = ToolUnit.mDisplayMetrics;
       int specMode = MeasureSpec.getMode(measureSpec);
       int specSize = MeasureSpec.getSize(measureSpec);
      // Log.i("Cache", "specMode_Width:"+specMode);
       //fill_parent或者精确值
        if (specMode == MeasureSpec.EXACTLY){

       }else{
    	   specSize = (int) (dm.widthPixels*width);
       }
   ...
   private int measureHeight(int measureSpec) {
       ...
       int specMode = MeasureSpec.getMode(measureSpec);
       int specSize = MeasureSpec.getSize(measureSpec);
      // Log.i("Cache", "specMode_height:"+specMode);
       //fill_parent或者精确值
      ...
      // a=MeasureSpec.UNSPECIFIED;
       if (specMode == MeasureSpec.EXACTLY){
    	   ...
    	   //wrap_content
    	   specSize = (int) (dm.heightPixels*height);
       }
