...
public class ToolShareSDK {
	...
	public Platform initPlatform(SharePlatform type){
		...
		switch (type) {
		case SinaWeibo:
			platForm = ShareSDK.getPlatform(MyApplication.gainContext(), SinaWeibo.NAME);
			break;
		case TencentWeibo:
			platForm = ShareSDK.getPlatform(MyApplication.gainContext(), TencentWeibo.NAME);
			break;
		case Wechat:
			//分享给朋友圈
			...
			platForm = ShareSDK.getPlatform(MyApplication.gainContext(), WechatMoments.NAME);
			break;
		default:
			break;
		}
