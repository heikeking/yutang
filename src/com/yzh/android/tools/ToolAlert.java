...
public class ToolAlert {
    ...
    public static void toastShort(String msg) {
        Toast.makeText(MyApplication.gainContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void toastLong(String msg) {
        Toast.makeText(MyApplication.gainContext(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static void toast(String msg,int duration) {
        Toast.makeText(MyApplication.gainContext(), msg, duration).show();
    }
