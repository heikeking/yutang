...
public class ChangePasswordModel extends DisPatcher{
	private Context mContext;
	public ChangePasswordModel(Context mContext) {
		this.mContext =mContext;
	}
	public void UpdatePassword(String userPassword, String userUpdatePassword, String userId) {
		Map<String, String> map = new HashMap<>();
		map.put("userId", userId);
		map.put("userPassword", userPassword);
		map.put("userUpdatePassword", userUpdatePassword);
		ToolHTTP.get(mContext, Contants.userUpdatePassword, map, new JsonHttpResponseHandler() {
			@Override
